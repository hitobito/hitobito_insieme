...
describe Vp2021::TimeRecord::Report::CapitalSubstrate do
  let(:year) { 2021 }
  ...
  context '#deckungsbeitrag4' do
    ...
    it 'does not include future years' do
      ...
      expect(report.deckungsbeitrag4_vp2021).to eq(5_000 + existing_db4)
    end
  end
  ...
  context 'IV Finanzierungsgrad' do
    ...
    it 'can be calculated for VP 2021' do
      ...
      expect(subject.iv_finanzierungsgrad_vp2021).to eql 0.5
    end
