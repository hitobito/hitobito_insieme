...
describe Fp2020::Export::Tabular::CourseReporting::ClientStatistics do
  let(:year) { 2020 }
  ...
  context "#data_rows" do
    ...
    it "contains correct sums" do
      ...
      expect(data[27]).to match_array(["Freiburg", 12607, nil, nil, nil, nil, nil, nil, nil, nil,
        ...
        nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil])
      # rubocop:enable Layout/LineLength
      expect(data[28]).to match_array(["Semester-/Jahreskurse", "Weiterbildung", 8, 0, nil, nil,
        # rubocop:todo Layout/LineLength
        nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil])
      # rubocop:enable Layout/LineLength
  ...
  it "contain correct sums according to client-setup" do
    ...
    expect(data[19][0..5]).to match_array(["Semester-/Jahreskurse", "Weiterbildung", 1, 150, 10,
      15])
    expect(data[20][0..5]).to match_array(["Semester-/Jahreskurse", "Sport/Freizeit", nil, nil,
      nil, nil])
  ...
  it "calculates aggregate_courses correctly" do
    ...
    # rubocop:enable Layout/LineLength
    expect(data[18][0..5]).to match_array(["Biel-Seeland", 3115, nil, nil, nil, nil])
    expect(data[19][0..5]).to match_array(["Semester-/Jahreskurse", "Weiterbildung", 6, 0, nil,
      nil])
    expect(data[20][0..5]).to match_array(["Semester-/Jahreskurse", "Sport/Freizeit", nil, nil,
      nil, nil])
    expect(data[21][0..5]).to match_array(["Blockkurse", "Weiterbildung", nil, nil, nil, nil])
  ...
  context "adds a part of a grundlagenarbeit to treffpunkt LE, it" do
    subject(:gcp) do
      Fp2020::CourseReporting::ClientStatistics::GroupCantonParticipant.new(
    ...
    before do
      ...
      TimeRecord::VolunteerWithoutVerificationTime.create!(group_id: gcp.group_id, year: year,
        kurse_grundlagen: 44)
    end
    ...
    it "matches the actual implementation result" do
      ...
      expect(fp_class("CostAccounting::Table")).to receive(:new).with(Group.find(gcp.group_id),
