...
describe Fp2015::Export::Tabular::CourseReporting::Aggregation do
  ...
  %w[bk tk].each do |leistungskategorie|
    context leistungskategorie do
      ...
      it "contains correct row headers, values and sums" do
        ...
        expect(rows[8]).to eq ["davon Absenztage Personen mit Behinderung", 0.50, 0.50, 1.00, nil, 0.50, 0.50, 0.50, nil, 0.50, 2.00]
        ...
        expect(rows[12]).to eq ["davon TeilnehmerInnentage Personen mit Behinderung", 1.5, 1.5, 3.00, nil, 1.5, 1.5, 1.5, nil, 1.5, 6.00]
  ...
  context "sk" do
    ...
    it "contains correct row headers, values and sums" do
      ...
      expect(rows[2]).to eq ["Anzahl Kursstunden", BigDecimal("4.0"), BigDecimal("4.0"), BigDecimal("8.0")]
      ...
      expect(rows[12]).to eq ["davon TeilnehmerInnenstunden Personen mit Behinderung", 0.0, 0.0, 0.00]
