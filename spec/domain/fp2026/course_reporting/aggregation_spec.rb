#  Copyright (c) 2026-2021, insieme Schweiz. This file is part of
...
describe Fp2026::CourseReporting::Aggregation do
  ...
  context "structure and counting courses" do
      ...
      context leistungskategorie do
        ...
        it "sums by inputkritierien" do
          kursfachkonzepte.each do |k|
            create!(create_course(leistungskategorie, [groups(:be)], 2026, k), :freizeit_und_sport)
          end
    ...
    context "sk" do
      ...
      it "sums once for all kursfachkonzepte" do
        kursfachkonzepte.each do |k|
          create!(create_course("sk", [groups(:be)], 2026, k), "freizeit_und_sport")
        end
  ...
  context "treffpunkt-aggregation" do
    ...
    let!(:treffpunkt_a_course_record) do
      ...
      create!(create_course("tp", [groups(:fr)], 2026, "treffpunkt"), "weiterbildung", cr_defaults.merge({
  ...
  def create_course(leistungskategorie = "bk", group_list = [groups(:be)], year = 2026,
