...
describe Fp2026::Export::Tabular::TimeRecords::OrganisationsDaten do
  let(:year) { 2026 }
  ...
  let(:data) do
    ...
    od.instance_variable_set(:@data_for, {
      verein_ids[0] => Fp2026::TimeRecord::OrganisationsDaten::Data.new(10, 5, 20, 8, 4),
      verein_ids[1] => Fp2026::TimeRecord::OrganisationsDaten::Data.new(*Array.new(5) { 0 }),
      verein_ids[2] => Fp2026::TimeRecord::OrganisationsDaten::Data.new(10, 5, 20, 7, 4),
      verein_ids[3] => Fp2026::TimeRecord::OrganisationsDaten::Data.new(*Array.new(5) { 0 })
    })
