...
module Fp2026
  describe Export::Tabular::Events::AggregateCourse::DetailList do
    ...
    it "exports detail events list as xlsx" do
      ...
      Export::Tabular::Events::AggregateCourse::DetailList.xlsx(courses, "test group name", "2026")
    end
