...
#  Copyright (c) 2026-2026, Insieme Schweiz. This file is part of
...
describe Fp2026::TimeRecord::Report::CapitalSubstrate do
  let(:year) { 2026 }
  ...
  context "current year within bounds" do
    it "has assumptions" do
      expect(year).to eql 2026
    end

    it "returns current year if within bounds" do
      expect(subject.current_or(2023, 2026)).to eql 2026
    end
