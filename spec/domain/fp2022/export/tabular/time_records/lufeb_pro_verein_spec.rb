...
describe Fp2022::Export::Tabular::TimeRecords::LufebProVerein do
  ...
  let(:data) do
    lpv = Fp2022::TimeRecord::LufebProVerein.new(year)
    verein_ids = lpv.vereine.map(&:id)

    lpv.instance_variable_set('@lufeb_data', {
      verein_ids[0] => Fp2022::TimeRecord::LufebProVerein::Data.new(1, 2, 3, 4, 5),
      verein_ids[1] => Fp2022::TimeRecord::LufebProVerein::Data.new(2, 4, 6, 8, 9),
      verein_ids[2] => Fp2022::TimeRecord::LufebProVerein::Data.new(Array.new(5) {0}),
      verein_ids[3] => Fp2022::TimeRecord::LufebProVerein::Data.new(Array.new(5) {0})
    })
