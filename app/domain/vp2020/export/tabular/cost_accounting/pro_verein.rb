...
module Vp2020::Export::Tabular::CostAccounting
  class ProVerein
    ...
    # Vp2020::CostAccounting::ProVerein
    ...
    def data_row(row_label, row_data)
      [vp_t(row_label), *row_data.members.map { |attr| row_data.send(attr) }]
    end

    def vp_t(field, options = {})
      I18n.t(field, options.merge(scope: vp_i18n_scope('cost_accounting.pro_verein')))
    end
  end
end
