...
module Vp2020::Export::Tabular::TimeRecords
  class LufebProVerein
    ...
    # Vp2020::TimeRecords::LufebProVerein
    ...
    def vp_t(field, options = {})
      I18n.t(field, options.merge(scope: vp_i18n_scope('time_records.lufeb_times')))
    end
  end
end
